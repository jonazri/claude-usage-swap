...
Semantics pinned here:
  ...
  - (2026-07-21, upstream #188) A live lane whose CURRENT account is disabled
    is EVICTED off it by decide_swap's Trigger 0 — to a clean target when one
...
# (2026-07-21, upstream #188, the slot-6/03 incident).
# --------------------------------------------------------------------------
